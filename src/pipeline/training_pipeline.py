...
from src.constants import SPLIT_FILE_NAME, RATINGS_SPLIT_FILE_NAME, ANIME_FILE_NAME
...
class TrainingPipeline:
    def __init__(self):
        ...
        self.hybrid_config = HybridRecommenderConfig()
    ...
    def run(self):
        ...
        hybrid_recommender = HybridRecommender(self.hybrid_config)
        hybrid_artifact = hybrid_recommender.run(ratings_df, content_artifact, user_artifact, anime_titles)

        return content_artifact, user_artifact, hybrid_artifact
